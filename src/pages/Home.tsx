    ...
    <>
      <div className="sm:max-md:px-[20px] sm:max-md:max-w-[100%] sm:max-md:mx-[0px] max-w-[1600px] mx-auto overflow-x-hidden">
        ...
        <section className="grid grid-cols-[1fr_1.8fr] md:hidden">
          <img
            src="https://drive.developershideout.com:4431/mrr_img/HomeImg3.png"
            alt="Home Image 3"
            className="translate-x-[8%]"
          />
          <img
            src="https://drive.developershideout.com:4431/mrr_img/HomeImg1.png"
            alt="Home Image 1"
            className="translate-x-[-8%]"
          />
        </section>
        ...
        <section className="sm:max-md:mt-[-10%] sm:max-md:pt-0 sm:max-md:w-[100%] sm:max-md:mx-0 md:max-lg:w-full md:max-lg:ml-0 md:max-lg:px-[20px] lg:max-xl:mx-[0px] lg:max-xl:ml-[20px] xl:max-xl:ml-[144px] lg:max-xl:text-lg w-1/2 mx-[210px] pt-20">
          <img
            className="sm:max-md:w-[50%] sm:max-md:ml-auto"
            src="https://drive.developershideout.com:4431/mrr_img/MANILA.png"
            alt="Manila"
          />
          ...
          <img
            ...
            src="https://drive.developershideout.com:4431/mrr_img/RUNWAY.png"
            alt="Runway"
          />
        </section>
        {/*Mobile Images*/}
        <section className="sm:max-md:mt-[-10%] grid grid-cols-[1.8fr_1fr] items-end md:hidden">
          <img
            src="https://drive.developershideout.com:4431/mrr_img/HomeImg2.png"
            alt="Home Image 2"
            className="translate-x-[8%]"
          />
          <img
            src="https://drive.developershideout.com:4431/mrr_img/HomeImg4.png"
            alt="Home Image 4"
            className="translate-x-[-8%]"
          />
        </section>
        ...
        <section className="sm:max-lg:translate-y-[0%] lg:max-xl:translate-y-[-60%] sm:max-md:pt-10 sm:max-md:px-0 md:max-lg:px-5 lg:max-xl:px-5 px-20 translate-y-[-80%]">
          <h2 className="sm:max-md:text-center sm:max-md:mb-0 text-2xl font-bold mb-4">
            Brand Partners
          </h2>
          <div className="sm:max-md:flex-col flex w-[100%] gap-8 justify-around">
            <div className="flex justify-center items-center">
              <img
                src="https://drive.developershideout.com:4431/mrr_img/logos/AlicioThailand.jpg"
            ...
            <div className="flex justify-center items-center">
              <img
                src="https://drive.developershideout.com:4431/mrr_img/logos/Diesel.jpg"
                alt="Diesel logo"
                className="sm:max-md:w-[140px] w-50"
              />
            </div>
            <div className="flex justify-center items-center">
              <img
                src="https://drive.developershideout.com:4431/mrr_img/logos/DKNY.jpg"
                alt="DKNY logo"
                className="sm:max-md:w-[140px] w-50"
              />
            </div>
